...
Main functions Usage:
     1. Open Pull_Images_From_AOML.py file
     2. Edit lines 169 - 176 with bucket name and AOML links
            event = {
     ...
     3. Run the script
            ...
            2. python /location of the file/Pull_Images_From_AOML.py


Another way is to call attached bash file
    1. ./location of the file/Pull_Images_From_AOML.sh
